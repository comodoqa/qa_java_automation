...
public class REGISTRY_KEY_EXISTS implements IAction{
	...
	public Boolean run(Map<String, String> parameters) {
		...
		printDebugging();
		//---Test
		String versionInRegistry = getRegistryKey();
		if(versionInRegistry == null || versionInRegistry.isEmpty()) {
			isPassed = false;
		}
		//---End Test
		if(isResultNegated) {
